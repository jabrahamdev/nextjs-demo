...
const getStaticPaths = async () => {
  ...
  const client = await external_mongodb_["MongoClient"].connect(`mongodb+srv://admin-jabraham:dunkel1mongo@cluster0.e4adw.mongodb.net/meetups?retryWrites=true&w=majority`);
  const db = client.db();
